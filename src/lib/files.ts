...
const cache = new LRUCache<string, string[]>({ max: 2048 });
 ...
 */
function getFilepathsSync(dir: string, filenames: string[] = []) {
 ...
 */
function getFilepathsByExtSync(dir: string, extFilters: string[] = []) {
 ...
 */
function getMarkdownFilepathsSync(dir: string) {
